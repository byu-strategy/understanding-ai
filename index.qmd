...
Welcome to *Understanding AI: From Foundations to Strategy*. This course seeks to help students climb the vast and rugged mountain of artificial intelligence (AI) and machine learning (ML) at a technical but still beginner accessible level of depth. We will not attempt to explore the entire mountain as this would be impossible in a single course. Instead, we will chart a path from the base of the mountain all the way to the peak. During the climb we will learn many of the most important AI/ML building blocks as we ascend higher. On reaching the peak (the end of the class) students will be able to see AI and ML from a new perspective and understand how modern LLMs and AI systems work (e.g. ChatGPT). The course is recommended for students who are ready to roll up their sleeves and get their hands dirty with the necessary math and code to understand how AI works from first principles. To excel in the course students should have taken a calculus, probability/stats, linear algebra, and have at least beginner level coding experience. A list of specific topics covered is shown in the figure below. Students can complete **this short assessment** to evaluate if they are prepared to succeed in the course.
